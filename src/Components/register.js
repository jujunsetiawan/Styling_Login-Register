    ...
    render() {
      ...
      <View>
       ...
       <View style = {{backgroundColor: "#77acd1", flexDirection: "row"}}>
         <TouchableOpacity onPress = {() => alert("Kembali Ke Menu Login")}>
             <Image style = {{height: 20, width:20, marginTop: 8, marginLeft: 10, opacity: 0.2}}
        ...
        <TouchableOpacity onPress = {() => alert("Masuk Halaman Login")}>
